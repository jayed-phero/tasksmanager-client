...
const Signup = () => {
    ...
    return (
        <div className=' dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 bg-gray-100'>
            <div className=' mx-auto max-w-7xl px-4 sm:px-6 flex items-start justify-center py-11 md:py-16  dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 '>
                <div class="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800 border-2  dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 ">
                    <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">TasksManager</h1>
                    <p className='text-center text-red py-3'>{error}</p>
                    <form onSubmit={handleSubmit} class="mt-6">
                        <div>
                            ...
                            <input type="text" name='name' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-6">
                            <button type='submit' class="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-700 
                            dark:bg-blue-500
                    ...
                    <p class="mt-8 text-xs font-light text-center text-gray-400"> Already have an account? <Link to='/signin' class="font-medium text-gray-700 dark:text-gray-200 hover:underline">Sign in</Link></p>
                </div>
            </div>
        </div>
    );
